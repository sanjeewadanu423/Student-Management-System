                ...
                <div class="container-fluid  d-flex flex-column p-0">
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar">
                        ...
                        <li class="nav-item">
                                            ...
                                            <a class="nav-link" href="{{ route('teachers') }}"><span>Teacher</span></a>
                                            <a class="nav-link" href="{{ route('students') }}"><span>Student</span></a>
                                            <a class="nav-link" href="{{ route('subjects') }}"><span>Subject</span></a>
                                            <a class="nav-link" href="{{ route('marks') }}"><span>Mark</span></a>
                        </li>
